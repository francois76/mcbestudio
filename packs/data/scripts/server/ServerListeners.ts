...
export class ServerListeners {
    ...
    private functions: any = {
        ...
        clientEnteredWorld(player: IEntity) {
            ...
            let playerPositionComponent = this._serverSystem.getComponent(player, MinecraftComponent.Position);
            let playerRotationComponent = this._serverSystem.getComponent(player, MinecraftComponent.Rotation);
